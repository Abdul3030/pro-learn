    ...
    return (
        <div className={`bottom z-10 flex w-full pr-5 bg-white ${active ? 'hidden' : 'block'}`}>
            <div className="">
                ...
                <div className="w-32 h-28 px-5 py-2 flex justify-center items-center shadow-pro">
            ...
            <div className="ml-5 flex-1">
                ...
                <div className="w-full h-28 px-5 py-2 flex justify-center items-center shadow-pro">
